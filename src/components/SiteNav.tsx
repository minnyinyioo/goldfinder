...
const zh=[["/","首页"],["/project","项目控制台"],["/atlas","真实图鉴"],["/knowledge","知识库"],["/sampling","取样计算"],["/planner","取样规划"],["/field","样品记录"],["/map","样点地图"],["/reports","现场报告"],["/sources","资料来源"],["/copyright","版权与免责声明"],["/about","安全说明"]];
const en=[["/en","Home"],["/en/project","Project"],["/en/atlas","Photo Atlas"],["/en/knowledge","Knowledge Base"],["/en/sampling","Sampling Tools"],["/en/planner","Sampling Design"],["/en/field","Sample Register"],["/en/map","Sample Mapping"],["/en/reports","Field Reports"],["/en/sources","References"],["/en/copyright","Copyright & Disclaimer"],["/en/about","Safety"]];
const pairs:Record<string,string>={"/":"/en","/project":"/en/project","/atlas":"/en/atlas","/knowledge":"/en/knowledge","/sampling":"/en/sampling","/planner":"/en/planner","/field":"/en/field","/map":"/en/map","/reports":"/en/reports","/sources":"/en/sources","/copyright":"/en/copyright","/about":"/en/about","/en":"/","/en/project":"/project","/en/atlas":"/atlas","/en/knowledge":"/knowledge","/en/sampling":"/sampling","/en/planner":"/planner","/en/field":"/field","/en/map":"/map","/en/reports":"/reports","/en/sources":"/sources","/en/copyright":"/copyright","/en/about":"/about"};
