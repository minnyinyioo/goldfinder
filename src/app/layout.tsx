...
export const metadata: Metadata = {
  ...
  alternates:{canonical:"/",languages:{"zh-CN":"/",en:"/en",my:"/my","x-default":"/"}},manifest:"/manifest.webmanifest",
...
const structured={"@context":"https://schema.org","@type":"WebSite",name:"Goldfinder",alternateName:["探金","ရွှေရှာဖွေ"],url:site,inLanguage:["zh-CN","en","my"],description:"Evidence-led field geology, mineral recognition, sampling and record tools.",publisher:{"@type":"Organization",name:"Goldfinder Project",url:site}};
