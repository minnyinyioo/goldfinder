...
const routes = [
  "", "/search", "/project", "/atlas", "/assess", "/knowledge",
  "/geology", "/tools", "/sampling", "/qaqc", "/planner", "/field",
  "/map", "/reports", "/backup", "/sources", "/copyright", "/about",
  "/en", "/en/search", "/en/project", "/en/atlas", "/en/assess",
  "/en/knowledge", "/en/geology", "/en/tools", "/en/sampling",
  "/en/qaqc", "/en/planner", "/en/field", "/en/map", "/en/reports",
  "/en/backup", "/en/sources", "/en/copyright", "/en/about",
  "/my", "/my/search", "/my/project", "/my/atlas", "/my/knowledge",
  "/my/tools", "/my/planner", "/my/qaqc", "/my/field", "/my/map",
  "/my/reports", "/my/backup", "/my/sources", "/my/copyright", "/my/about",
];
...
for (const route of routes) {
  ...
  if (!html.includes("GOLDFINDER")) failures.push(`${route || "/"}: site marker missing`);
...
for (const path of discoveredInternal) {
  ...
  if (!response.ok) failures.push(`${path}: internal link returned HTTP ${response.status}`);
}
